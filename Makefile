...
backend: ## Start AssetMint compliance API (port 3001)
	...
	@CLAIM_ISSUER_KEY=$$(openssl rand -hex 32) OPERATOR_PRIVATE_KEY=ab08984d79824336161553b77e366abde831ebde78d78f0440e6833b2f2e2f92 cargo run -p assetmint-core --quiet &
	@sleep 3
